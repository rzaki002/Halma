...
<body>
    ...
    <header class="header-section d-none d-xl-block">
        <div class="header-wrapper">
            ...
            <!-- End Header Top -->
            <div class="header-bottom header-bottom-color--golden section-fluid sticky-header sticky-color--golden pt-10">
                        ...
                        <div class="sidebar-single-widget">
                            <div class="sidebar-content">
                                <a href="product-details-default.html" class="sidebar-banner img-hover-zoom">
                                    <img class="img-fluid"
                                        src="{{ asset('halma-fe/assets/images/banner/side-banner.jpg') }}"
                                        alt="">
                                </a>
                            </div>
                        </div> <!-- End Single Sidebar Widget -->
                                ...
                                <div class="product-details-gallery-area mb-7">
                                    ...
                                    <div class="product-large-image modal-product-image-large swiper-container">
                                        <div class="swiper-wrapper">
                                            ...
                                            <div class="product-image-large-image swiper-slide img-responsive">
                                                <img src="{{ asset('halma-fe/assets/images/product/default/home-1/default-2.jpg') }}"
                                                    alt="">
                                            </div>
                                            <div class="product-image-large-image swiper-slide img-responsive">
                                                <img src="{{ asset('halma-fe/assets/images/product/default/home-1/default-3.jpg') }}"
                                                    alt="">
                                            </div>
                                            <div class="product-image-large-image swiper-slide img-responsive">
                                                <img src="{{ asset('halma-fe/assets/images/product/default/home-1/default-4.jpg') }}"
                                                    alt="">
                                            </div>
                                            <div class="product-image-large-image swiper-slide img-responsive">
                                                <img src="{{ asset('halma-fe/assets/images/product/default/home-1/default-5.jpg') }}"
                                                    alt="">
                                            </div>
                                            <div class="product-image-large-image swiper-slide img-responsive">
                                                <img src="{{ asset('halma-fe/assets/images/product/default/home-1/default-6.jpg') }}"
                                                    alt="">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="product-details-variable">
                                        ...
                                        <div class="d-flex align-items-center flex-wrap">
                                            ...
                                            <div class="variable-single-item ">
                                                ...
                                                <div class="product-variable-gambar">
                                                    <input type="file" name="gambar" class="form-control" placeholder="image">
                                                    
                                                      </div>
                                                      <p>Silakan masukkan file design dengan format jpeg/png/jpg/psd</p>
                                                </div>
                                            </div>
                                            <div class="variable-single-item ">
    ...
    <script>
        function getData(){
            ...
            $.ajax({
                type:'GET',
                url:'http://127.0.0.1:8000/produks/5',
